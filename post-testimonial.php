...
if(strlen($_SESSION['login'])==0 && !isset($_SESSION['active']))
  {
        ...
        <div class="profile_wrap">
          <h5 class="uppercase underline">Post a Testimonial</h5>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control white_bg" id="testimonial" name="testimonial" rows="4"></textarea>
                <div id="testimonial-status" style="font-size:12px;"></div>
            </div>


            <div class="form-group">
                <a class="btn" id="check_booking">Save  <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
            </div>
        </div>
      </div>
    </div>
...
<script>
    $("#check_booking").on("click", function(){
        $("#loaderIcon").show();
        jQuery.ajax({
            url: "check_booking.php",
            data:'testimonial='+$("#testimonial").val(),
            type: "POST",
